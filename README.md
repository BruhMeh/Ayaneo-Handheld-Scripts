...
* **sameboy_auto_config.sh:** Automatically downloads the SameBoy core, and configures an LCD + Pixel Transparency shader as the core default. 
* **gambatte_auto_config.sh:** Automatically downloads the Gambatte core, and configures an LCD + Pixel Transparency shader as the core default.
